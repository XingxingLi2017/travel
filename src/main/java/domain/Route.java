...
public class Route implements Serializable {
    ...
    private double price;           // route price
    private String routeIntroduce;      // route introduction
    private String rflag;       // route available flag
    private String rdate;       //  route open date
    private String isThemeTour;     // if the route has a theme
    private int count;              // how many positions available left
    private int cid;                // route category's id
    private String rimage;      // route image url
    private int sid;                // route seller's id
    private String sourceId;            // route source id

    private Category category;          // category object
    private Seller seller;              // seller object
    private List<RouteImg> routeImgList;    // list of route detail image
